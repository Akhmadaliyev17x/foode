...
import '../../data/repo_impl/auth_repository_implementation.dart';
...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  FutureOr<void> authSignInRequested(
      AuthSignInRequestedEvent event, Emitter<AuthState> emit) async {
    emit(AuthLoading());
    try {
  ...
  FutureOr<void> authSignUpStep1Requested(
      AuthSignUpStep1RequestedEvent event, Emitter<AuthState> emit) async {
    emit(AuthLoading());
    try {
  ...
  FutureOr<void> authSignUpStep2Requested(
      AuthSignUpStep2RequestedEvent event, Emitter<AuthState> emit) async {
    emit(AuthLoading());
    try {
  ...
  FutureOr<void> updateProfileImageRequested(
  ...
  FutureOr<void> updateUserLocationRequested(
      UpdateUserLocationEvent event, Emitter<AuthState> emit) async {
    emit(AuthLoading());
    try {
  ...
  FutureOr<void> removeProfileImageRequested(
      RemoveProfileImageEvent event, Emitter<AuthState> emit) async {
    emit(AuthLoading());
    try {
  ...
  FutureOr<void> removeUserLocationRequested(
      RemoveUserLocationEvent event, Emitter<AuthState> emit) async {
    emit(AuthLoading());
    try {
  ...
  FutureOr<void> updateUserProfileRequested(
  ...
  FutureOr<void> getUserFromFireStoreRequested(
      GetUserFromFireStoreEvent event, Emitter<AuthState> emit) async {
    emit(AuthLoading());
    try {
